 ...
 */
  ...
  class CaptchaComponent extends Component	{
     ...
     * @var array
     */
    private $__fonts = array('anonymous', 'droidsans');
     ...
     * Constructor
     *
     * @param ComponentRegistry $registry A formerly known "ComponentCollection" this component can use to lazy load its   components
