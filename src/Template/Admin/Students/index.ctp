<h1><?php echo __('Manage Students'); ?></h1>
		...
		<tr valign="top">
			<td align="left" class="searchbox">
				...
				<div class="floatright top5">
					...
					'Students', 'action' => 'add', 'prefix' => 'admin'))?>" class="black_btn">
						<span>Add New Student</span>
					</a>
					<a href="<?php echo $this->Url->build(array('controller' => 
					'Students', 'action' => 'addCsv', 'prefix' => 'admin'))?>" class="black_btn">
						<span>Import Students</span>
					</a>
					<a href="<?php echo $this->Url->build(array('controller' => 
					'Areas', 'action' => 'exportCsv', 'Students', 'prefix' => 'admin'))?>" class="black_btn">
...
<div class="row mtop30">
	...
	<table width="100%" cellspacing="0" cellpadding="0" border="0" align="center" class="listing">
		<tr>
			...
			<th><?php echo $this->Paginator->sort('Students.first_name', 'Name'); ?></th>
			<th><?php echo $this->Paginator->sort('Users.first_name', 'Teacher'); ?></th>
			<th><?php echo $this->Paginator->sort('Students.created', 'Created'); ?></th>
			<th><?php echo $this->Paginator->sort('Students.status', 'Status'); ?></th>
		...
		?>
			 <tr>
				...
				<td align="center"><?php echo isset($user->user) ? $user->user->first_name. ' '.$user->user->last_name : '&mdash;'?></td>
				<td align="center"><?php echo ($user->created) ? $user->created->format('d/m/Y H:i:s') : '' ?></td>
				<td align="center"><?php echo ($user->status ==1) ? 'Active' : 'Inactive'; ?></td>
				<td align="center" valign="middle" >&nbsp;<?php echo 
				$this->Html->link($this->Html->image('edit_icon.gif'), 
				array('prefix' => 'admin', 'controller' => 'Students', 'action' => 
				'edit', $user->id), array('escape' => false)); ?></td>
