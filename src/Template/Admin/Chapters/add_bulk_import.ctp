...
<div class="row">
    <div class="floatleft mtop10">
    	<h1>
    		<?php echo __('Add Chapters - Bulk Import'); ?>
		</h1>
	</div>
    <div class="floatright">
        <?php
			echo $this->Html->link('<span>'.__('Back To Manage Chapters').'</span>', array('action' => 'index'),array('class'=>'black_btn', 'escape'=>false));
		?>
	</div>
</div>
<div align="center" class="whitebox mtop15">
    ...
    <table cellspacing="0" cellpadding="7" border="0" align="center">
		<tr>
			<td align="left"><strong class="upper">Chapter Type</strong></td>
			<td align="left">
			<?php
				$chapter_type = ['1'=>'Primary', '2'=>'Elementry'];
				echo $this->Form->input(
					'chapter_type', array(
						'options'=>$chapter_type,
						'empty'=>'Chapter Type',
						'label'=>false,
